 ...
 * @return {Object} - this
 */
function _liamandersonColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_liamandersonColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_liamandersonColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_liamandersonColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _liamandersonColor object.
 *
 * @since Twenty Twenty 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function liamandersonColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _liamandersonColor( backgroundColor, accentHue );
