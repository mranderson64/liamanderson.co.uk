...
if ( ! class_exists( 'liamanderson_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 */
	class liamanderson_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'liamanderson_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'liamanderson_get_localized_font_family_elements',
				array(
			...
			return liamanderson_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
